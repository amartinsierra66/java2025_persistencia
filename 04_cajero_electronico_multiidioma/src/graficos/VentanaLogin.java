...
public class VentanaLogin extends JFrame {
	...
	public VentanaLogin() {
		...
		lblNewLabel.setBounds(57, 51, 127, 23);
		contentPane.add(lblNewLabel);
		
		jtfCuenta = new JTextField();
		jtfCuenta.setBounds(213, 52, 127, 20);
		...
		//modificar idiomas de textos
		ResourceBundle bundle=ResourceBundle.getBundle("textos", Locale.getDefault());
		lblNewLabel.setText(bundle.getString("etiqueta"));
		jbtEntrar.setText(bundle.getString("boton"));
